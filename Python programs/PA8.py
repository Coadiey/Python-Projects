...
#-This program also shows the highest card, accounting for Aces as well
#
...
def main():       
        ...
        card1 = Card(suitgiver,rankgiver) # this will create a card that is a Queen of Diamonds
        ...
        card2 = Card(suitgiver2,rankgiver2)
        rank2 = card2.getModRank()
        suit2 = card2.getModSuit()
        print("Card #2: %s of %s" % (rank2, suit2))
        
        suitgiver3 = random.randint(0,3) # these 3 lines will create a “random” card from the deck
        rankgiver3 = random.randint(1,13)
        card3 = Card(suitgiver3,rankgiver3)
        rank3 = card3.getModRank()
        suit3 = card3.getModSuit()
        print("Card #3: %s of %s" % (rank3, suit3))
        highestCard = rankgiver
        aceDict = {1:14,14:'Ace'}
        if rankgiver in aceDict:
            rankgiver = 14
            highestCard = rankgiver
        ...
        print()
        print("Card #{0} is the high card: {1} of {2}".format(highs,ranks,suits))
